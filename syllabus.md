...
| Week 7 | More with maps - bqplot, cartopy, ipyleaflet | 1. VAD Ch. 8: Arrange Spatial Data <br> 2. <a href="https://serialmentor.com/dataviz/geospatial-data.html">FDA, Ch. 15: Visualizing geospatial data</a> <br> 3. <a href="https://scitools.org.uk/cartopy/docs/latest/">Cartopy docs</a>; <a href="https://ipyleaflet.readthedocs.io/en/latest/">ipyleaflet docs</a>
| Week 8 | Break | None
| Week 9 | Network Viz & Word cloud Viz & beginning web dev & Publishing | VAD Ch. 9: Arrange Networks and Trees
