...
class HistogramButtonSliderCustomD3Component extends D3Component { // change name
	...
	var svg = this.svg = d3.select(node).append('svg') //; // take this out!
...
module.exports = HistogramButtonSliderCustomD3Component; // add histogram here
